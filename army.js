...
client.on('message', async msg => { 
	...
	if(message.content.includes(',play', ',p')){
...
/////////////////					
	...
	} else if(message.content.includes(',skip', ',s')){
	...
	} else if(message.content.includes(',volume', ',v')){
	...
	} else if(message.content.includes(',queue', ',q')){
...
**Now playing :** **${serverQueue.songs[0].title}**`)
	...
	} else if(message.content.includes(',resume', ',r')){
